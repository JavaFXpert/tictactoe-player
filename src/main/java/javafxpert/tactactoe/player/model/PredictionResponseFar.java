...
public class PredictionResponseFar {
  ...
  public PredictionResponseFar() {
  }

  public PredictionResponseFar(boolean inputsNormalized, int prediction, List<Double> activations, int numOutputNodes) {
